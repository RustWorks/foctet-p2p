...
use foctet_net::{endpoint::Endpoint, protocol::TransportProtocol, transport::{connection::{Connection, FoctetConnection}, stream::FoctetStream}};
            ...
            Ok(frame) => {
                ...
                match frame.frame_type {
                    ...
                    FrameType::ContentRequest => {
                        ...
                        match conn.send_file_parallel(&file_path, chunk_size).await {
                            Ok(_) => {
